...
/***/ function(module, exports, __webpack_require__) {
	...
	var authEvents = __webpack_require__(32);
	var appApi = __webpack_require__(5);
	var appUi = __webpack_require__(6);
	var logic = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#btn-new-icon').on('click', function (e) {
	    ...
	    var data = '{ "profile": { "pic": "' + app.profile.pic + '" } }';
...
/***/ function(module, exports) {
	...
	var app = {
	  ...
	  api: 'https://whereoke-api.herokuapp.com/'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getProfile = function getProfile(success, failure) {
	...
	var createProfile = function createProfile(success, failure, data) {
	...
	var updateProfile = function updateProfile(success, failure, data) {
	...
	var getBars = function getBars(success, failure) {
	...
	var newFavorite = function newFavorite(success, failure, data) {
	...
	var removeFavorite = function removeFavorite(success, failure, favID) {
	...
	var newReview = function newReview(success, failure, data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(4);
	var logic = __webpack_require__(7);
	var google = __webpack_require__(8);
	var appApi = __webpack_require__(5);

	var actionsOnLogOut = function actionsOnLogOut() {
	...
	var actionsOnLogIn = function actionsOnLogIn() {
	...
	var getProfileSuccess = function getProfileSuccess(data) {
	...
	var getBarsSuccess = function getBarsSuccess(data) {
	  console.log(data);
	...
	module.exports = {
	  ...
	  getBarsSuccess: getBarsSuccess,
	  updateProfileSuccess: updateProfileSuccess,
	  actionsOnLogOut: actionsOnLogOut,
	  actionsOnLogIn: actionsOnLogIn
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var filterBarsOnDay = function filterBarsOnDay() {
	  var allBars = app.bars;
	  var barsToday = [];
	...
	var selectAltDay = function selectAltDay(altDay) {
	  var allBars = app.bars;
	  var barsToday = [];
	  for (var i = 0; i < allBars.length; i++) {
	...
	var loadFavorites = function loadFavorites() {
	  ...
	  var listingTemplate = __webpack_require__(9);
	...
	var reloadBarCarousel = function reloadBarCarousel() {
	  console.log('reloading bar carousel...');
	  var data = app.barsByDay;
	  console.log(data);

	  var listingTemplate = __webpack_require__(29);
	...
	var loadBarCarousel = function loadBarCarousel() {
	  ...
	  $('.add-review').on('submit', function (event) {
	    ...
	    console.log(data);
	    var dataJSON = '{ "review": { "bar_id": ' + data.review.bar_id + ', "profile_id":' + app.profile.id + ' , "comment": "' + data.review.comment + '", "rating": ' + parseInt(data.review.rating) + '} }';
	...
	var updateBarsSuccess = function updateBarsSuccess(data) {
	  console.log(data);
	  app.bars = data.bars;
	...
	var updateBarFailure = function updateBarFailure(data) {
	  console.error(data);
	  console.log('Error updating bars');
	};

	var getProfilefailure = function getProfilefailure(data) {
	  console.error(data);
	  console.log('Error getting profile');
	};

	var newReviewSuccess = function newReviewSuccess(data) {
	  console.log(data);
	  console.log('New review added');
	  appApi.getBars(updateBarsSuccess, updateBarFailure);
	};

	var newReviewFailure = function newReviewFailure(data) {
	  console.error(data);
	  console.log('Error submitting review');
	};

	var removeFavSuccess = function removeFavSuccess() {
	  ...
	  for (var i = 0; i < app.profile.fav_bars.length; i++) {
	  ...
	  for (var _i3 = 0; _i3 < data.length; _i3++) {
	    var bar = data[_i3];
	    bar.yourRatingHearts = '';
	    bar.yourRating = app.bars[app.profile.fav_bars[_i3].id - 1].yourRating;
	    for (var _i4 = 0; _i4 < bar.yourRating; _i4++) {
	      bar.yourRatingHearts += "<span class='glyphicon glyphicon-heart'></span>";
	    }
	    for (var _i5 = 0; _i5 < 5 - bar.yourRating; _i5++) {
	      bar.yourRatingHearts += "<span class='grey-heart'><span class='glyphicon glyphicon-heart'></span></span>";
	    }
	  }

	  // console.log(fav_bars);
	  var listingTemplate = __webpack_require__(31);
	...
	var removeFavfailure = function removeFavfailure(error) {
	  console.error(error);
	};

	var newFavSuccess = function newFavSuccess(data) {
	  console.log(data);
	...
	var newFavfailure = function newFavfailure(error) {
	  console.error("This bar is already in your favorites.");
	  $("#fav-fail-modal").modal('show');
	};

	var addBarFavorite = function addBarFavorite() {
	  $('.add-favorite').on('submit', function (event) {
	    event.preventDefault();
	    var data = getFormFields(this);
	    app.addedBar = data.favorite.bar_id;
	    var dataJSON = '{ "favorite": { "bar_id": ' + data.favorite.bar_id + ', "profile_id":' + app.profile.id + ' } }';
	...
	var removeBarFavorite = function removeBarFavorite() {
	  $('.remove-favorite').on('submit', function (event) {
	    event.preventDefault();
	    var data = getFormFields(this);
	    app.removedBar = data.favorite.bar_id;
	    var fav_id = void 0;
	    for (var i = 0; i < app.profile.favorites.length; i++) {
	...
	var calcAvgRating = function calcAvgRating() {
	  for (var i = 0; i < app.bars.length; i++) {
	    var bar = app.bars[i];
	    var sum = 0;
	    bar.avgRatingHearts = '';
	    if (bar.reviews.length > 0) {
	      for (var _i6 = 0; _i6 < bar.reviews.length; _i6++) {
	        sum += bar.reviews[_i6].rating;
	      }
	      bar.avgRating = Math.round(sum / bar.reviews.length);
	      for (var _i7 = 0; _i7 < bar.avgRating; _i7++) {
	        bar.avgRatingHearts += "<span class='glyphicon glyphicon-heart'></span>";
	      }
	      for (var _i8 = 0; _i8 < 5 - bar.avgRating; _i8++) {
	...
	var calcYourRating = function calcYourRating() {
	  for (var i = 0; i < app.bars.length; i++) {
	    var bar = app.bars[i];
	    bar.yourRatingHearts = '';
	    if (bar.reviews.length > 0) {
	      for (var _i9 = 0; _i9 < bar.reviews.length; _i9++) {
	        if (bar.reviews[_i9].profile_id === app.profile.id) {
	          bar.yourRating = bar.reviews[_i9].rating;
	          for (var _i10 = 0; _i10 < bar.yourRating; _i10++) {
	            bar.yourRatingHearts += "<span class='glyphicon glyphicon-heart'></span>";
	          }
	          for (var _i11 = 0; _i11 < 5 - bar.yourRating; _i11++) {
	            bar.yourRatingHearts += "<span class='grey-heart'><span class='glyphicon glyphicon-heart'></span></span>";
	          }
	        }
	      }
	    ...
	    if (bar.fav_profiles.length > 0) {
	      for (var _i12 = 0; _i12 < bar.fav_profiles.length; _i12++) {
	        if (bar.fav_profiles[_i12].id === app.profile.id) {
	...
	module.exports = {
	  ...
	  filterBarsOnDay: filterBarsOnDay,
	  today: today,
	  loadBarCarousel: loadBarCarousel,
	  addBarFavorite: addBarFavorite,
	  removeBarFavorite: removeBarFavorite,
	  calcAvgRating: calcAvgRating,
	  calcYourRating: calcYourRating,
	  selectAltDay: selectAltDay,
	  reloadBarCarousel: reloadBarCarousel
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapGeocoder = function mapGeocoder() {
	  console.log('updating google map...');
	  var bars = app.barsByDay;
	  // console.log(bars);
	  app.addresses = [];
	  var names = [];
	  var cityStates = [];
	  ...
	  if (geocoder) {
	    var _loop = function _loop(_i) {
	      geocoder.geocode({ 'address': app.addresses[_i] }, function (results, status) {
	          ...
	          if (status !== google.maps.GeocoderStatus.ZERO_RESULTS) {
	            (function () {
	              ...
	              var marker = new google.maps.Marker({
	                ...
	                map: map,
	                title: app.addresses[_i]
	              });
	              google.maps.event.addListener(marker, 'click', function () {
	                infowindow.close();
	                infowindow.setContent('<b>' + names[_i] + '</b><br>' + cityStates[_i]);
	    ...
	    for (var _i = 0; _i < app.addresses.length; _i++) {
	      _loop(_i);
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <ul class=\"fav-list-item\">\n      <h4 class=\"bar-name\">"
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "</h4>\n      <label class=\"bar-address\">"
	    ...
	    + "</label>\n      <span class=\"rating-delete-group\">\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.yourRating : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
	    + "      <span class=\"btn-delete-bar\" hidden><button type=\"button\" class=\"btn btn-danger btn-xs\" data-toggle=\"modal\" data-target=\"#remove-favorites-modal-"
	  ...
	  return "          <span class='rating'>"
	    + ((stack1 = container.lambda((depth0 != null ? depth0.yourRatingHearts : depth0), depth0)) != null ? stack1 : "")
	    + " </span>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "          <a href=\"#\" id=\"write-a-review\" class=\"review-test\" data-toggle=\"modal\" data-target=\"#write-review-modal-"
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Review this bar</a>\n";
	},"6":function(container,depth0,helpers,partials,data) {
	    var alias1=container.lambda, alias2=container.escapeExpression;

	  return "  <div class=\"modal fade remove-favorites-modal\" id=\"remove-favorites-modal-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n          <h4 class=\"modal-title\" id=\"myModalLabel\">Remove "
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + " from favorites?</h4>\n        </div>\n        <div class=\"modal-body\">\n          <form id=\"remove-favorite-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" class=\"remove-favorite\">\n            <div class=\"form-group\" hidden>\n              <textarea name=\"favorite[bar_id]\" class=\"form-control\">"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "</textarea>\n            </div>\n            <button type=\"submit\" class=\"btn btn-primary\">Yes, please</button>\n            <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Nevermind</button>\n          </form>\n        </div>\n      </div>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=depth0 != null ? depth0 : {};

	  return "<div class=\"fav-list\">\n  <h6>\n    <a href=\"#\" id=\"edit-favorites\">Edit Favorites</a>\n    <a href=\"#\" id=\"done-edit-favorites\" hidden>Done Editing</a>\n  </h6>\n  <div class=\"list-of-favs\">\n"
	    ...
	    + "</div>\n</div>\n\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.data : depth0),{"name":"each","hash":{},"fn":container.program(6, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "        <li data-target=\"#bars-carousel\" data-slide-to=\""
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.id : depth0), depth0))
	    + "\"></li>\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : {};

	  return "      <div class=\"item\">\n        <div class=\"overlay\"></div>\n        <img class=\"street-view-image street-view-image-logged-out clip\" src=\"https://maps.googleapis.com/maps/api/streetview?size=640x583&location="
	    + alias2(alias1((depth0 != null ? depth0.address : depth0), depth0))
	    + ","
	    + alias2(alias1((depth0 != null ? depth0.city : depth0), depth0))
	    + ","
	    + alias2(alias1((depth0 != null ? depth0.state : depth0), depth0))
	    + "&scale=2&pitch=5&key=AIzaSyDyIX1_gmBhMrXFfGI_0bDXRQibEGqW_B0\">\n        <div class=\"carousel-caption-container\">\n        <div class=\"carousel-caption\">\n          <h1>"
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "</h1>\n          <h4>"
	    + alias2(alias1((depth0 != null ? depth0.address : depth0), depth0))
	    + ", "
	    ...
	    + alias2(alias1((depth0 != null ? depth0.state : depth0), depth0))
	    + "</h4>\n"
	    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.avgRating : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.program(6, data, 0),"data":data})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.yourRating : depth0),{"name":"if","hash":{},"fn":container.program(8, data, 0),"inverse":container.program(10, data, 0),"data":data})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.yourFavorite : depth0),{"name":"if","hash":{},"fn":container.program(12, data, 0),"inverse":container.program(14, data, 0),"data":data})) != null ? stack1 : "")
	    + "        </div>\n      </div>\n      </div>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "            <h4>Average user rating: <span class='rating-small'>"
	    + ((stack1 = container.lambda((depth0 != null ? depth0.avgRatingHearts : depth0), depth0)) != null ? stack1 : "")
	    + " </span></h4>\n";
	},"6":function(container,depth0,helpers,partials,data) {
	    return "            <h4>Bar not yet rated by any users</h4>\n";
	},"8":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "            <h4 class=\"logged-in-option\" hidden>\n              Your rating: <span class='rating-small'>"
	    + ((stack1 = container.lambda((depth0 != null ? depth0.yourRatingHearts : depth0), depth0)) != null ? stack1 : "")
	    + " </span>\n            </h4>\n";
	},"10":function(container,depth0,helpers,partials,data) {
	    return "            <h4 class=\"logged-in-option\" hidden>\n              <a href=\"#\" id=\"write-a-review\" class=\"logged-in-option\" data-toggle=\"modal\" data-target=\"#write-review-modal-"
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Write a Review</a>\n            </h4>\n";
	},"12":function(container,depth0,helpers,partials,data) {
	    var alias1=container.lambda, alias2=container.escapeExpression;

	  return "          <h5 class=\"logged-in-option\" hidden>\n            <a href=\"#\" data-toggle=\"modal\" data-target=\"#remove-favorites-modal-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" id=\"remove-fav-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Remove from Favorites</a><a href=\"#\" data-toggle=\"modal\" data-target=\"#add-favorites-modal-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" id=\"add-fav-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" hidden>Add to Favorites</a>\n          </h5>\n";
	  ...
	  return "          <h5 class=\"logged-in-option\" hidden>\n            <a href=\"#\" data-toggle=\"modal\" data-target=\"#remove-favorites-modal-"
	    ...
	    + "\" id=\"remove-fav-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" hidden>Remove from Favorites</a><a href=\"#\" data-toggle=\"modal\" data-target=\"#add-favorites-modal-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" id=\"add-fav-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Add to Favorites</a>\n          </h5>\n";
	  ...
	  return "<div id=\"bars-carousel\" class=\"carousel slide\" data-ride=\"carousel\">\n\n  <!-- Indicators -->\n  <ol class=\"carousel-indicators\" id=\"carousel-indicators\">\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.data : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
...
/***/ function(module, exports, __webpack_require__) {
	...
	var authUi = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var registerSuccess = function registerSuccess(data) {
	  ...
	  var newUserID = '{ "profile": { "user_id":' + app.user.id + ' } }';
	...
	var regFail = function regFail(error) {
	  console.error(error);
	  $("#sign-up-modal").modal('hide');
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(47);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
